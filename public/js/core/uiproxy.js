...
define(function (require, exports, module) {
    ...
    var defaults = {
        ...
        // 点击时长，超过这个时间则不认为是点击
        // U3长按500毫秒则弹出菜单
        // ios: UILongPressGestureRecognizerDiscussion; The time interval is in seconds. The default duration is is 0.5 seconds.
        tapMaxInterval: 500, // milliseconds 
    ...
    UIProxy.prototype.isTap = function (options) {
        ...
        return d && (options.currentTime - options.startTime < defaults.tapMaxInterval);
    };
